...
def perspectiveTransform(src):
    ...
    dst = cv2.imread('Task/Images/map-top-view.jpg', -1)
    dst_copy = dst.copy()
    cv2.namedWindow('dst')
...
def MapCoordinates():
    ...
    frame = cv2.imread("Task/Images/Initial/sampleInitial1.jpg")
    ...
    frame, H, mask = perspectiveTransform(frame)

...
int move(int angle, long int length)
{
  ...
  while (logic == 0)
  {
    ...
    sta_fin = min(1.0, (float)((float)length - lengthOfRobot) / (length * 0.15)) * min(1.0, (float)(lengthOfRobot + 10.0) / (length * 0.15));
    roboclaw1.SpeedM1(address1, (int)(Va_base * sta_fin));
    roboclaw1.SpeedM1(address2, (int)(Vb_base * sta_fin));
    roboclaw1.SpeedM1(address3, (int)(Vc_base * sta_fin));
